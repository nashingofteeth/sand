...
//-->
  ...
  <body onload="push()">
	<div id="sidebar">
	  <img onclick="location.reload();" style="width: 20px; cursor: pointer; height: 18px; margin:0px 0px 5px 0px;" src="icon.png"/><br>
	  <button title="Fullscreen preview: Ctrl+," onclick="click1()">&#60;</button><br> 
	  <button title="Split view: Ctrl+m or Esc" onclick="click2()">|</button><br>
	  <button title="Code view: Ctrl+." onclick="click3()">&#62;</button><br>
	...
	<footer>v3.2 rev.<br><a href="http://mtthw.me">MN</a></footer>
    <script>
      var delay;
