...
shortcut = {
	...
	'remove':function(shortcut_combination) {
		...
		<script type="text/javascript"> 
			...
			function help() {
			alert('Save to account: Ctrl+Alt+S   FULLSCREEN: Ctrl+Alt+P or click the textbox 4 times.   EXIT FULLSCREEN: Esc or click the Exit Fullscreen.   HELP: Ctrl+Alt+H');
            }
...
$con = mysql_connect("localhost:3306","root","");
		...
		WHERE username='$user'") or die($result."<br/><br/>".mysql_error());
		$row = mysql_fetch_array($result);
		$data = $row['data'];
		
		echo "<textarea id='code' onkeyup='update()' onclick='Set_Count_Mouse()' height='100%' width='100%' autofocus required name='ta' wrap='hard' spellcheck='false' class='code' placeholder='Type your HTML here...'>$data</textarea>";
		if (isset($_POST['ta'])) {
			$sql = "UPDATE members SET data = '$_POST[ta]'
			WHERE username = '$user'";
...
?>
			...
			<div id="footer">
				...
				<a style="margin-left: 10px;" href="index.php"><a href="index.php">Home</a> | <a href="javascript: help()">Hotkeys</a> | <a href="logout.php">Logout</a>
				<input type="button" value="Save To Account" onclick="document.code.submit();"/>
			</div>
        </form>
    </body> 
</html>