...
shortcut = {
	...
	'remove':function(shortcut_combination) {
		...
		<script type="text/javascript"> 
			...
			function help() {
			alert('Save: Ctrl+Alt+S   Open URL: Ctrl+Alt+O or click textbox 5 times.   FULLSCREEN: Ctrl+Alt+F or click the textbox 4 times.   EXIT FULLSCREEN: Esc or click the Exit Fullscreen.   HELP: Ctrl+Alt+H');
            }
    ...
    <body id="body" onload="update()"> 
        <div id="fullscreenOff" onclick="split()">X</div> 
        ...
        <form name="code" method="post">
			<textarea id='code' onkeyup='update()' onclick='Set_Count_Mouse()' height='100%' width='100%' autofocus required name='ta' wrap='hard' spellcheck='false' id='code' placeholder='Type your HTML here...'></textarea>";
			<div id="footer">
				<a href="javascript: help()">Hotkeys</a> | Bookmarklet: <a href="javascript: var orig=location.href;location.replace('http://mtthw.me/instabin/?url='+orig);" title="Drag to your bookmark bar">Open with Instabin</a>
